...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "RedHouse: crash, mines, roulette and leveraged markets with demo Robux.",
      },
  ...
  return (
    <QueryClientProvider client={queryClient}>
      ...
      <footer className="mt-16 border-t border-border/60 py-8 text-center text-xs text-muted-foreground">
        RedHouse is a demo product. Balances are simulated — no real Robux, no payments. 18+.
      </footer>
